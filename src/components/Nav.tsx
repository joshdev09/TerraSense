  ...
  return (
    <div className="px-4 py-2.5 bg-white border-b border-[#E8E6DA] sticky top-0 z-20">
      <div className="flex flex-row justify-between items-center">
        ...
        <button
          className="
            px-3 py-2 rounded-xl text-sm font-medium text-[12px] flex flex-row items-center gap-1.5 text-[#F6F4E8] bg-[#333] relative overflow-hidden transition-all duration-250 ease-in-out hover:text-[#333] hover:bg-[#A2CB8B] hover:shadow-md hover:scale-[1.03] active:scale-[0.97] cursor-pointer focus:outline-none focus-visible:ring-2 focus-visible:ring-[#A2CB8B]
          "
        >
